...
describe('adminQuizNameUpdate', () => {
  ...
  test('Valid use of adminQuizNameUpdate', () => {
    ...
    const quizinfo2 = adminQuizInfo(user.authUserId, quiz.quizId);
  ...
  test('Quiz does not belong to User', () => {
    ...
    const quiz2 = adminQuizCreate(user2.authUserId, 'Quiz 2', 'This is quiz 2');
...
describe('adminQuizDescriptionUpdate', () => {
  ...
  test('Successfully update description', () => {
    const inforObjectOriginal = adminQuizInfo(user.authUserId, quiz.quizId);
    expect(adminQuizDescriptionUpdate(user.authUserId, quiz.quizId, '')).toStrictEqual({});
    const inforObjectNew = adminQuizInfo(user.authUserId, quiz.quizId);
  ...
  test('Quiz ID does not refer to a quiz that this user owns, belongs to somebody else', () => {
    const user2 = adminAuthRegister('somebody@unsw.edu.au', 'password2', 'Jias', 'Koals');
    adminAuthLogin('somebody@unsw.edu.au', 'password2');
    const quiz2 = adminQuizCreate(user2.authUserId, 'Quiz by user 2', 'User 2 quiz');
...
describe('adminQuizInfo', () => {
  ...
  test('QuizId does not belong to user', () => {
    const user2 = adminAuthRegister('hayden.smith2@unsw.edu.au', 'password2', 'nameFirstttt', 'nameLastttt');
    adminAuthLogin('hayden.smith2@unsw.edu.au', 'password2');
    adminQuizCreate(user2.authUserId, 'Quiz 2', 'This is quiz 2');
...
describe('adminQuizList', () => {
  ...
  test('Successful case: one item in the list', () => {
    // 2nd person
    const user2 = adminAuthRegister('jayden2.smith@unsw.edu.au', 'password2', 'nameFirst', 'nameLast');
  ...
  test('Successful case: many items in the list', () => {
    ...
    const quiz2 = adminQuizCreate(user.authUserId, 'Hayden second quiz', 'This is quiz 2');
    const quiz3 = adminQuizCreate(user.authUserId, 'Hayden third quiz', 'This is quiz 3');
    const quiz4 = adminQuizCreate(user.authUserId, 'Hayden 4th quiz', 'This is quiz 4');
